...
export async function getSuggestions(text) {
  ...
  // const { data } = { data: [{ Version: 1, Key: '38046', Type: 'City', Rank: 55, LocalizedName: 'Quixadá', Country: { ID: 'BR', LocalizedName: 'Brazil' }, AdministrativeArea: { ID: 'CE', LocalizedName: 'Ceará' } }] }
  // console.log(data)
  return data;
